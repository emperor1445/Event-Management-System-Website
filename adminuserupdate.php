...
session_start();
    ...
    if(!empty($_GET['SdID'])){
        ...
        $sql="SELECT * FROM student where SdID='".$SdID."' ;";
        $result=$conn->query($sql);
        $row=$result->fetch(PDO::FETCH_ASSOC);
    
        $_SESSION['SdID']=$row['SdID'];
        $name=$row['SDname'];
            ...
            if(!empty(
	            ...
	            $_GET['phone']&&$_GET['password']))
	            {
                    ...
                    $password=$_GET['password'];
                        ...
                        $sql="UPDATE student SET SDname=:sdn ,SDemail=:sde ,SDimg=:sdimg ,SDphone=:sdp ,SDpassword=:sdpass,SDmajor=:sdm
